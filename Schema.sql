...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2018 at 12:20 PM
...
--
-- Table structure for table `bukutabungan`
--
...
--
-- Dumping data for table `bukutabungan`
--
...
--
-- Table structure for table `detailpenyetoran`
--
...
--
-- Dumping data for table `detailpenyetoran`
--
...
--
-- Table structure for table `detailstatus`
--
...
--
-- Dumping data for table `detailstatus`
--
...
--
-- Table structure for table `jemputsampah`
--
...
--
-- Dumping data for table `jemputsampah`
--
...
INSERT INTO `nasabah` (`username`, `password`, `nama`, `alamat`, `tipeNasabah`, `email`, `noHP`, `saldo`) VALUES
...
('M001', '131313', 'Meylisa Marali', 'Jl. Atletik Malang', 'Nasabah Kelompok', 'bam@gmail.com', '081289890989', 121600),
...
INSERT INTO `petugas` (`idPetugas`, `username`, `nama`, `password`, `alamat`, `tipe`, `email`, `noHP`) VALUES
(1, 'P001', 'admin', 'admin1', 'Malang', 'Admin', 'admin@hotmail.com', '085751116277'),
(2, 'P002', 'Bambang Hidayat', 'driver', 'Blimbling', 'Driver', 'chris@ymail.com', '081399778957');
...
--
ALTER TABLE `detailstatus`
  MODIFY `idDetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
--
