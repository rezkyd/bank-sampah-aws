        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="card">
                <div class="card-body">
                  <form class="form-horizontal" method="post" action="<?php echo site_url("c_akun/updateAkun/".$username);?>">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4 offset-sm-2">
                        <a type="submit" class="btn btn-secondary" href="<?php if($akun=='n'){ echo site_url('c_akun');} else{ echo site_url('c_akun/lihatPetugas');} ?>">Batal</a>
